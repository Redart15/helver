...
import redart15.helver.block.TriggerStandOn;
...
public abstract class EntityMixinBlockStandOn {
	...
	public boolean insureAlwaysTriggerEvent(
		...
		if(!original && blockWalkedOn != null && blockWalkedOn.getLogic() instanceof TriggerStandOn){
	...
	public boolean onEntityStand(
		...
		if(!original && blockWalkedOn != null && blockWalkedOn.getLogic() instanceof TriggerStandOn){
			Entity asThis = (Entity) (Object) this;
			TriggerStandOn triggeredBlock = (TriggerStandOn) blockWalkedOn.getLogic();
